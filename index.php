...
if ($isCurrentUser) {
    ...
    $user = $result->fetch_assoc(); // Mengambil satu baris hasil
}
                    ...
                    <a class="nav-link text-secondary" href="profile.php">
                        <?php if ($isCurrentUser && isset($user)): ?>
                            <?php if (isset($user['profile_picture']) && !empty($user['profile_picture'])): ?>
                                <img src="profile_pictures/<?php echo htmlspecialchars($user['profile_picture']); ?>" alt="Profile Picture" style="width:50px; height:50px; " class="d-inline-block align-text-top">
                            <?php else: ?>
                                <img src="profile.png" alt="Profile Picture" style="width:60px; height:60px; border-radius:10px;" class="d-inline-block align-text-top">
                            <?php endif; ?>
                        <?php endif; ?>
                    </a>
                </li>
